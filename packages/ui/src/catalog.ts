...
export const catalog: readonly CatalogItem[] = [
  ...
  },
  {
    ...
    kind: 'block',
    category: null,
    description: 'A page title band with a breadcrumb trail, a supporting line and a row of actions.',
    source: 'src/blocks/page-header-01/index.tsx',
    exports: ['PageHeader01'],
    status: 'stable',
  },
  {
    name: 'DataTable01',
  ...
  },
  {
    ...
    kind: 'block',
    category: null,
    description: 'A settings form grouped into sections of text, select and switch fields.',
    source: 'src/blocks/settings-panel-01/index.tsx',
    exports: ['SettingsPanel01'],
    status: 'stable',
  },
  {
    name: 'AuthForm01',
    ...
    kind: 'block',
    category: null,
    description: 'A sign-in card with labelled credential fields, a remember control and an error slot.',
    source: 'src/blocks/auth-form-01/index.tsx',
    exports: ['AuthForm01'],
    status: 'stable',
  },
  {
    ...
    kind: 'block',
    category: null,
    description: 'A navigation shell with a desktop rail, a top bar and a mobile navigation sheet.',
    source: 'src/blocks/app-shell-01/index.tsx',
    exports: ['AppShell01'],
    status: 'stable',
  },
]
