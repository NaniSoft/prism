---
title: "Input"
description: "A text input integrated with Prism fields and validation."
---
...
Input is a Prism-owned component. Its behavior, public props, and Spectral Refraction recipe ship together from `@nanisoft/prism-ui`.
