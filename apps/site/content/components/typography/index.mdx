---
title: "Typography"
description: "Prism text, heading, and refracted display primitives."
---
...
Typography is a Prism-owned component. Its behavior, public props, and Spectral Refraction recipe ship together from `@nanisoft/prism-ui`.
