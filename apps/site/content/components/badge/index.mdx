---
title: "Badge"
description: "A small, non-interactive status or metadata label."
---
...
Badge is a Prism-owned component. Its behavior, public props, and Spectral Refraction recipe ship together from `@nanisoft/prism-ui`.
