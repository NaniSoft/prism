---
title: "Kbd"
description: "A keyboard-key annotation."
---
...
Kbd is a Prism-owned component. Its behavior, public props, and Spectral Refraction recipe ship together from `@nanisoft/prism-ui`.
