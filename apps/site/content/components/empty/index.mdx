---
title: "Empty"
description: "A purposeful no-results state with a clear next action."
---
...
Empty is a Prism-owned component. Its behavior, public props, and Spectral Refraction recipe ship together from `@nanisoft/prism-ui`.
